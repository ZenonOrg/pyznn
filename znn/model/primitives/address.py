...
PTLC_ADDRESS = Address.parse("z1qxemdeddedxptlcxxxxxxxxxxxxxxxxx6lqady")
BITCOIN_SPV_ADDRESS = Address.parse("z1qxemdeddedxtr3dlxxxxxxxxxxxxxxxxqsmv59")
GOVERNANCE_ADDRESS = Address.parse("z1qxemdeddedxg0vernancexxxxxxxxxxxklyh23")
ATOMIC_SWAP_ADDRESS = Address.parse("z1qxemdeddedx2wrz6nvvvvvvvvvvvvvgv4am6a")
